#!/usr/bin/env python3
"""
Implements a class that demonstrates deletion-resilient hypermedia pagination.
"""
...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """
        Returned a hypermedia-indexed data dict.

        This methods reads data in a way that is reslient to deletion. if
